...
function(set_shader_values TARGET)
    if(${TARGET} STREQUAL "D3D9")
        set(VS_FLAGS "--platform" "windows" "-p" "s_3_0" "-O" "3" PARENT_SCOPE)
        set(FS_FLAGS "--platform" "windows" "-p" "s_3_0" "-O" "3" PARENT_SCOPE)
        set(SHADER_PATH "${SHADER_BIN_DIR}/dx9" PARENT_SCOPE)
    elseif(${TARGET} STREQUAL "D3D11")
        set(VS_FLAGS "--platform" "windows" "-p" "s_5_0" "-O" "3" PARENT_SCOPE)
        set(FS_FLAGS "--platform" "windows" "-p" "s_5_0" "-O" "3" PARENT_SCOPE)
        set(CS_FLAGS "--platform" "windows" "-p" "s_5_0" "-O" "1" PARENT_SCOPE)
